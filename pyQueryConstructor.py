...
class QueryConstructor():
    ...
    def aggQueryConstructor(self, qstring, qgte, qlte, qsize, qinterval, wildCard=True, qtformat="epoch_millis",
                            qmin_doc_count=1):
    ...
    def systemQuery(self):
        return "System metrics query"
...
if __name__ == "__main__":
    ...
    test = qConstructor.aggQueryConstructor(qstring, qgte, qlte, qsize, qinterval, wildCard, qtformat,
                                                 qmin_doc_count)
    print test
